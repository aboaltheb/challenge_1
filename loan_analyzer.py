...
print("Total Number of Loans:", Number_Of_Loans)

# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans
total_value_of_all_loans = sum(loan_costs)
print("Total Value of All Loans:", total_value_of_all_loans)

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_loan_amount = total_value_of_all_loans/Number_Of_Loans
...
interest_rate = 0.2
present_value = future_value / ((1 + interest_rate/12) ** remaining_months)
...
new_loan_present_value = new_loan_future_value/((1 + interest_rate/12) ** new_loan_remaining_months)
